...
const updateForm = document.getElementById('form_update_animal');
    ...
    const optionLocation = document.getElementById('option_location');
    const optionHome = document.getElementById('option_home');
    ...
    attributAnimal.addEventListener('change', function() {
      ...
      switch (attributValue) {
        ...
        case "4":
          ...
          label4.setAttribute("for", "update_habitat");
          label4.setAttribute("id", "label")
          label4.textContent = "Son habitat : ";

          optionHome.style.display = 'block';

          resultValue.appendChild(label4);

          break;
        case "5":
          let label5 = document.createElement("label");
          label5.setAttribute("for", "update_origin");
          label5.setAttribute("id", "label")
          label5.textContent = "Sa nouvelle origine : ";

          optionLocation.style.display = 'block';

          resultValue.appendChild(label5);
